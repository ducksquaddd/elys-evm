...
replace (
	...
	cosmossdk.io/store => github.com/cosmos/cosmos-sdk/store v1.1.2

	// Third-party replaces
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0
	// Pin Cosmos SDK core & store to v0.53.4
	github.com/cosmos/cosmos-sdk => github.com/cosmos/cosmos-sdk v0.53.4

	// ELYS MODIFICATION: Use custom cosmos/evm fork with bank balance override
	github.com/cosmos/evm => github.com/ducksquaddd/evm v0.0.0-20250805001655-a1f614db5d88
	github.com/dgrijalva/jwt-go => github.com/golang-jwt/jwt/v4 v4.4.2

	// Upstream Go-Ethereum for EVM hooks
